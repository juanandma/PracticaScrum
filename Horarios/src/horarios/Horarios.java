...
//            System.out.println("Nombre por teclado " + nom);
//            System.out.println("ID por teclado " + id);
//            System.out.println("Nombre del fichero " + asignaturas.get(i).getNombre());
//            System.out.println("ID del fichero " + asignaturas.get(i).getID());
